...
class FaceRecognition:
    ...
    model_pkl_file = "face_recognition_model.pkl"  # Path to save/load the trained model
    ...
    def load_model(self):
        if os.path.exists(self.model_pkl_file):
            ...
            self.frame_thickness = model_data['frame_thickness']
            self.font_thickness = model_data['font_thickness']
            self.model = model_data['model']
        else:
            raise FileNotFoundError("Model file not found. Run encode_faces() to create the model.")
